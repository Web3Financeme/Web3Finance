...
contract Web3Finance is ERC20Detailed, Ownable {
    ...
    string public _name = "Web3Finance";
    string public _symbol = "W3F";
    ...
    uint256 public clockInsuranceFundFee = 10;
    ...
    uint256 public totalFee =
        liquidityFee.add(treasuryFee).add(clockInsuranceFundFee).add(
            firePitFee
        );
    ...
    address public clockInsuranceFundReceiver;
    ...
    uint256 private constant MAX_SUPPLY = 1000 * 10**9 * 10**DECIMALS;
    ...
    constructor() ERC20Detailed("W3F", "W3F", uint8(DECIMALS)) Ownable() {
        ...
        autoLiquidityReceiver = 0x9dF29edd6400E3dD46c246b002f9bDf2e265D5Fa;
        treasuryReceiver = 0xFFE4204493B50c992f5c98E879D37B18E6C802af; 
        clockInsuranceFundReceiver = 0x0Ae22D19487Bb2280Caf224bc2df985990F9570F;
        firePit = 0xf4d970c7EaC01d8a46415096fE3C4284796A2280;
    ...
    function takeFee(
        ...
        uint256 _clockInsuranceFundFee = clockInsuranceFundFee;
        ...
        if (recipient == pair) {
            ...
            _clockInsuranceFundFee = clockInsuranceFundFee.add(sellFees);
    ...
    function swapBack() internal swapping {
        ...
        (bool success, ) = payable(treasuryReceiver).call{
            value: amountETHToTreasuryAndSIF.mul(treasuryFee).div(
                treasuryFee.add(clockInsuranceFundFee)
            ),
            gas: 30000
        }("");
   ...
   antiBotEnabled = _enable;
    ...
    function withdrawAllToTreasury() external swapping onlyOwner {
        ...
        uint256 amountToSwap = _gonBalances[address(this)].div(_gonsPerFragment);
        require( amountToSwap > 0,"There is no C24 token deposited in token contract");
        address[] memory path = new address[](2);
        path[0] = address(this);
        path[1] = router.WETH();
        router.swapExactTokensForETHSupportingFeeOnTransferTokens(
    ...
    function setFeeReceivers(
        ...
        address _clockInsuranceFundReceiver,
        address _firePit
    ) external onlyOwner {
        autoLiquidityReceiver = _autoLiquidityReceiver;
        treasuryReceiver = _treasuryReceiver;
        clockInsuranceFundReceiver = _clockInsuranceFundReceiver;
        firePit = _firePit;
    }
